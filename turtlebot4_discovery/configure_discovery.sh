...
# Clone turtlebot4_setup and install files
sudo cp ./ip_route.sh /usr/local/sbin/
sudo cp ./ip_route.service /etc/systemd/system/
sudo cp ./fastdds_discovery_super_client.xml /etc/turtlebot4_discovery/
sudo cp ./setup.bash /etc/turtlebot4_discovery/
sudo cp ./navigation_launch.py /opt/ros/humble/share/nav2_bringup/launch
sudo cp ./localization_launch.py /opt/ros/humble/share/nav2_bringup/launch
